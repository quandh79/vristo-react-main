...
const LoginCover = () => {
    ...
    interface User {
      ...
      const handleInput = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Sử dụng callback để đảm bảo state luôn cập nhật giá trị mới
        setUser((prev) => ({
          ...prev,
          [name]: value,  // Đảm bảo TypeScript hiểu name là key của user
        }));
        console.log(user);
      };
    const submitForm =async (e:any) => {
        ...
        console.log('respone: ' + u.data.token)
        //navigate('/');
    };
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Password" onChange={handleInput} name='password' type="password" placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark" />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
