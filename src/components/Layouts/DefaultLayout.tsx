import { PropsWithChildren, Suspense, useEffect, useState, useReducer } from 'react';
    ...
    return (
        ...
        <App>
            ...
            <div className="relative">
                ...
                <div className={`${(!themeConfig.sidebar && 'hidden') || ''} fixed inset-0 bg-[black]/60 z-50 lg:hidden`} onClick={() => dispatchs(toggleSidebar())}></div>
                {/* screen loader */}
                {showLoader && (
